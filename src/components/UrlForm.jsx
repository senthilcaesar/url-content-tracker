...
export function UrlForm({
  ...
  const statusClass = (formData.status || "Pending")
    .replace(/\s+/g, "")
    .toLowerCase();
  ...
  const accentColor =
    formData.color && formData.color !== "none"
        ...
        <div className="hud-body">
            ...
            >
              <div className="card-header">
                ...
                <div className="card-actions" style={{ opacity: 0.3 }}>
                  <button type="button" style={{ padding: "6px" }}>
                    <Trash2 size={16} />
                  </button>
                </div>
              </div>
              ...
              <div className="card-body">
                ...
                <p className="card-desc">
                  {formData.description ||
                    "Provide a brief summary of the URL shelf contents."}
                </p>
          ...
          <div className="hud-console-panel">
            <form onSubmit={handleSubmit} className="hud-form">
              ...
              {/* Folder Selector — pick an existing folder or create a new one */}
              <div
                className="hud-form-group"
                ref={folderRef}
              ...
              >
                ...
                {creatingFolder ? (
                  <div className="hud-folder-create">
                    <input
                      type="text"
                      autoFocus
                    ...
                    <button
                      type="button"
                      className="hud-folder-create-cancel"
                      onClick={() => {
                        setCreatingFolder(false);
                  ...
                  <div className="hud-custom-select-container">
                    ...
                    <AnimatePresence>
                      {folderOpen && (
                        ...
                        >
                          <li
                            className={`hud-custom-dropdown-item ${!formData.folder ? "selected" : ""}`}
                            onClick={() => {
                              setFormData({ ...formData, folder: "" });
                              setFolderOpen(false);
                            }}
              ...
              <div className="hud-footer">
                <button
                  type="button"
                  className="hud-btn hud-btn-abort"
                  onClick={onClose}
                >
                  Cancel
                </button>
